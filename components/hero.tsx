  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          <img
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/747-vKsSSb0BG051ryL55hyDpwFrhdvAtO.png"
            alt="Apple"
        ...
        >
          The{" "}
          <span className="text-[#0071e3] font-semibold">Apple Method</span>{" "}
        ...
        >
          Discover how people are saving on iPhones, MacBooks, AirPods, and everyday Apple essentials.
        </p>
        ...
        >
          <a
            href="https://trksy.org/aff_c?offer_id=1701&aff_id=26188"
            target="_blank"
            rel="noopener noreferrer"
            className="touch-button group inline-flex items-center gap-3 bg-[#0071e3] text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-[#0056b3] transition-all duration-300 hover:shadow-xl hover:shadow-[#0071e3]/20 hover:-translate-y-0.5"
          >
            APPLY NOW
        ...
        >
          ...
          <p className="text-sm text-muted-foreground/70 font-medium">
            <span className="sm:hidden">Join 12,000+ Apple users who&apos;ve<br />already claimed their rewards.</span>
            <span className="hidden sm:inline">Join 12,000+ Apple users who&apos;ve already claimed their rewards.</span>
          </p>
        </div>
      </div>
    </section>
